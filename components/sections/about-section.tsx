                ...
                <SectionWrapper>
                    ...
                    <div className="max-w-5xl mx-auto">
                        ...
                        <motion.div
                            ...
                            className="glass dark:glass-dark p-8 md:p-10 rounded-2xl mb-12"
                        >
                            <div className="flex flex-col md:flex-row gap-10 items-center md:items-start">
                                ...
                                >
                                    <div className="relative">
                                        ...
                                        <div className="relative w-52 h-64 md:w-60 md:h-72 rounded-2xl overflow-hidden border-2 border-white/10">
                                            <Image
                                ...
                                <div className="flex-1 text-center md:text-left">
                                    ...
                                    <p className="text-sm text-primary font-medium mb-4 tracking-wide">{personalInfo.title}</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {highlights.map((highlight, index) => (
                                <motion.div
                                    ...
                                    className="group relative p-6 rounded-xl border bg-card overflow-hidden cursor-pointer transition-all duration-500 hover:shadow-2xl hover:shadow-primary/15 hover:border-primary/30"
                                >
                                    ...
                                    <div className="relative flex items-start gap-4">
                                        <div className="p-3 rounded-lg bg-primary/10 group-hover:bg-primary/20 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
                                            <highlight.icon className="h-6 w-6 text-primary group-hover:scale-110 transition-transform duration-500" />
                                        </div>
                                        <div>
                                            <h3 className="font-semibold mb-2 group-hover:text-primary transition-colors duration-300">{highlight.title}</h3>
